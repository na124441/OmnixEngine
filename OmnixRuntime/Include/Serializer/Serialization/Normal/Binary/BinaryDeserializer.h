...
#include <memory>
#include <glm/glm.hpp>
#include "Serializer/Serialization/Normal/Binary/BinaryReader.h"
#include "Serializer/Serialization/Normal/Binary/BinarySerializer.h"  // For scope IDs and data structures
