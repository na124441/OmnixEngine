...
public:
    ...
    virtual void FixedUpdate(void* physicsWorld, class Coordinator& coordinator, float fixedDt) {}
    virtual Entity GetPlayerEntity() const { return 0xFFFFFFFF; }
    virtual void SetPlayerEntity(Entity player) {}
};
