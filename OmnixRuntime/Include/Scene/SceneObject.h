...
public:
    ...
    bool m_HasGroundSection = false;
    eng::runtime::GroundSectionComponent m_GroundSection;
    ...
    void SetGroundSection(const eng::runtime::GroundSectionComponent& comp) { m_GroundSection = comp; m_HasGroundSection = true; }
    void ClearGroundSection() { m_HasGroundSection = false; }
